...
excerpt: 'Lorem markdownum evinctus ut cape adhaeret gravis licet progenies ut haesit maxima ille.'
...
<BlockImgText src="/uploads/unsplash-lylCw4zcA7I.jpg" alt="test" position="right">
  Hello, the current date is 2/16/2023. Quis semper [vulputate](https://example.com)
  &#x20;aliquam venenatdis egestas sagittis quisque orci. Donec commodo sdit&#x20;
  viverra aliquam porttitor ultrices gravida eu. Tincidunt leo, elementum&#x20;
  mattis elementum ut nisl, justo, amet, mattis. Nunc purus, diam cdommodo
  &#x20;tincidunt turpis. Amet, duis sed elit interdum dignissim
</BlockImgText>

<Gallery
  Images={[
    { src: "/uploads/netlify-advanced-build-settings.png", alt: "Test 2" },
    { src: "/uploads/Diagram.png", alt: "test" }
  ]}
/>
